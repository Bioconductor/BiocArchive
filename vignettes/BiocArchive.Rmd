---
title: "BiocArchive: Installation of Legacy Bioconductor Releases"
author: "Marcel Ramos"
...
[CRAN](https://cran.r-project.org/) packages from either the Posit Public
Package Manager (`P3M`) or the CRAN
...
default is to install `CRAN` packages from the P3M snapshot repository.

# P3M installations

The [Posit Public Package Manager](https://packagemanager.posit.co/client/)
(`P3M`) allows installations of packages from their respective snapshot
...
to `P3M`. By default, the package uses `P3M` snapshots tied
...
with those in the `P3M` repository.
